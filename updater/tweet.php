...
$winner = $db->query('SELECT throne_scores.score, throne_players.name FROM throne_scores LEFT JOIN throne_players ON throne_players.steamid = throne_scores.steamId WHERE throne_scores.dayId = ' .
    $today . ' ORDER BY rank ASC LIMIT 0,1');
