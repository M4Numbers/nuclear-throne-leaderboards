...
class Leaderboard {
    ...
    public function create_player($steamid, $order_by = "date", $direction = "DESC", $start = 0, $length = 0,
                                  $date = -1) {
        return $this->make_leaderboard("throne_scores`.`steamid", $steamid, $order_by, $direction, $start, $length,
            $date);
    }
